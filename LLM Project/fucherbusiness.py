...
# Streamlit UI
filled = st.selectbox("Select Filled ", ["AI", "Data Science", "Web Development", "Cybersecurity", "Cloud Computing"])
amount = st.text_input("Enter Amount to invest (e.g. Data Scientist, ML Engineer, Web Developer)")
profit = st.selectbox("Select minimum profit per ", ["Bootcamp", "Certification", "Degree", "Self-paced Learning"])
